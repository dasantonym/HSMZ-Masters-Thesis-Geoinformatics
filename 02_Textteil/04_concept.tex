...
Although the reference implementation was not designed to support an actual artistic process, it nonetheless is informed by past practical experience working with technology in a performance and specifically in a dance context.
