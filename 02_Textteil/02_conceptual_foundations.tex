...
The Docker team eventually launched the \ac{OCI} in 2015, which serves as \textquote[\cite{openContainerInitiative}]{a lightweight, open governance structure (project), formed under the auspices of the Linux Foundation, for the express purpose of creating open industry standards around container formats and runtimes}. It subsequently received Docker's container runtime as a donation, which was released as runC version 1.0 in 2020~\parencite{openContainerInitiative}.
