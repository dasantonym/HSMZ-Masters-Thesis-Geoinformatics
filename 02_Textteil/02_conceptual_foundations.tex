...
Both definitions lend themselves to support this study's approach as it attempts to establish a virtual presence in the local physical space using a sonic avatar and provides a mediated form of interaction through verbal communication to develop an illusion of social presence.
...
These concepts provide a more nuanced alternative to the idea of immersion, which rather is interpretated as the degree of plausibility of artificial stimuli shaping the experience within a virtual or mediated environment.
They are a guiding conceptual basis for the design processes of the modes of expression and interaction within the telepresence application, as a deep involvement and flow would be beneficial to shape a feeling of \textquote{togetherness} in a shared task of creating sound or music.
