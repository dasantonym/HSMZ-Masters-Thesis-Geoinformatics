...
As the libraries and frameworks that make up the broad spectrum of available web development technologies tend to favour different paradigms that in turn are also subject to change due to trends and \textquote{hype cycles}, it can be difficult to keep up and daunting to make an informed choice among the available options.
