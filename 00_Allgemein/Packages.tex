...
\usepackage[disable]{todonotes} % to disable todos use option disable, alternatively use obeyDraft or obeyFinal
...
\usepackage[hidelinks, colorlinks, allcolors=., urlcolor=blue]{hyperref} % Für digitale version
% \usepackage[hidelinks, colorlinks, allcolors=.]{hyperref} % Für print version
\usepackage{bookmark}
\hypersetup{
    pdftitle={\titel},
    pdfauthor={\autor},
...
\AtBeginDocument{
\newlength{\mylen}
\setlength{\mylen}{\widthof{100}} %TODO hier Text eintragen, der der breitesten Seitennummer im Inhaltsverzeichnis oder einem der anderne Verzeichnisse entspricht
